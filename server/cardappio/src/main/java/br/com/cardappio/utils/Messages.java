...
public class Messages {
    ...
    public static final String EMPTY_INGREDIENT = "Campo ingrediente não pode ficar vazio";
    ...
    public static final String EMPTY_CATEGORY = "Campo categoria não pode ficar vazio";
